                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel<?php echo $machine['MachineID']; ?>">Edit
                                            Machine</h5>
                                    ...
                                    <form method="post" action="">
                                        <div class="modal-body">
                                            <input type="hidden" name="machine_id" value="<?php echo $machine['MachineID']; ?>">
                                            <div class="mb-3">
                                                <label for="edit_name_<?php echo $machine['MachineID']; ?>"
                                                    class="form-label">Name</label>
                                                <input type="text" class="form-control"
                                                    id="edit_name_<?php echo $machine['MachineID']; ?>" name="edit_name"
                                                    value="<?php echo htmlspecialchars($machine['Name']); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_status_<?php echo $machine['MachineID']; ?>"
                                                    class="form-label">Status</label>
                                                <select class="form-control"
                                                    id="edit_status_<?php echo $machine['MachineID']; ?>" name="edit_status"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_capacity_<?php echo $machine['MachineID']; ?>"
                                                    class="form-label">Capacity (tons)</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="edit_location_<?php echo $machine['MachineID']; ?>" name="edit_location"
                                                    value="<?php echo htmlspecialchars($machine['Location']); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_model_<?php echo $machine['MachineID']; ?>"
                                                    class="form-label">Model</label>
                                                <input type="text" class="form-control"
                                                    id="edit_model_<?php echo $machine['MachineID']; ?>" name="edit_model"
                                                    value="<?php echo htmlspecialchars($machine['Model']); ?>" required>
                                            </div>
                                        </div>
