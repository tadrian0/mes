...
if (!$machine) {
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="globalSearch"
                                    placeholder="Search machine name, model...">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <select class="form-select filter-input" id="filter_city" data-col-index="4">
                                <option value="">All Cities</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <select class="form-select filter-input" id="filter_plant" data-col-index="5">
                                <option value="">All Plants</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <select class="form-select filter-input" id="filter_section" data-col-index="6">
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#totemSelectTable').DataTable({
                    ajax: 'api/machines-fetch.php', // Reusing existing API
                    columns: [
                        { data: 'MachineID' },
                        {
                            data: 'Name',
    ...
    <?php
    exit; // Stop execution here if we rendered the selection screen
}
